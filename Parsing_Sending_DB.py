    ...
    try:
        ...
        query = '''
                    INSERT INTO debtor_status_newau (
                        ...
                        Адрес_для_корреспонденции, e_mail, СРО_АУ, Адрес_СРО_АУ, статус_утверждения_АУ
        ...
        values = (
            ...
            data.get('статус_утверждения_АУ'),
        )
    ...
    try:
        ...
        query = '''
                    INSERT INTO debtor_status_newau (
                        ...
                        ОГРНИП, СНИЛС, Ранее_имевшиеся_ФИО, Категория_должника, Место_жительства, 
                        Дополнительная_информация, Краткое_наименование, Полное_наименование, Адрес, 
                        Телефон, ОГРН, ОКПО, Организационно_правовая_форма, статус_утверждения_АУ
